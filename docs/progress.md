...
- Результат: все 16 изображений галерей Нью-Йорка, Москвы, Минска и Парижа прошли отдельную
  ...
  приведены к фактическому разрешению `3840×2160`.
- Файлы: `public/images/stores/{new-york,moscow,minsk,paris}/*.png`, `docs/progress.md`.
- Проверки: декодирование и размеры всех 16 PNG проверены через System.Drawing; по одному ключевому
