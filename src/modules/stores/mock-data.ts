...
export const stores = [
  {
    ...
    images: [
      {
        src: "/images/stores/new-york/01-facade.png",
        alt: "Фасад магазина Virtual Space в Нью-Йорке",
        label: "Фасад",
      },
      {
        src: "/images/stores/new-york/02-interior.png",
        alt: "Общий вид магазина Virtual Space в Нью-Йорке",
        label: "Интерьер",
      },
      {
        src: "/images/stores/new-york/03-reception.png",
        alt: "Ресепшен магазина Virtual Space в Нью-Йорке",
        label: "Ресепшен",
      },
      {
        src: "/images/stores/new-york/04-detail.png",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/stores/moscow/02-interior.png",
        alt: "Общий вид магазина Virtual Space в Москве",
        label: "Интерьер",
      },
      {
        src: "/images/stores/moscow/01-facade.png",
        alt: "Фасад магазина Virtual Space в Москве",
        label: "Фасад",
      },
      {
        src: "/images/stores/moscow/03-reception.png",
        alt: "Ресепшен магазина Virtual Space в Москве",
        label: "Ресепшен",
      },
      {
        src: "/images/stores/moscow/04-detail.png",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/stores/minsk/01-facade.png",
        alt: "Фасад магазина Virtual Space в Минске",
        label: "Фасад",
      },
      {
        src: "/images/stores/minsk/02-interior.png",
        alt: "Общий вид магазина Virtual Space в Минске",
        label: "Интерьер",
      },
      {
        src: "/images/stores/minsk/03-reception.png",
        alt: "Ресепшен магазина Virtual Space в Минске",
        label: "Ресепшен",
      },
      {
        src: "/images/stores/minsk/04-detail.png",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/stores/paris/02-interior.png",
        alt: "Общий вид магазина Virtual Space в Париже",
        label: "Интерьер",
      },
      {
        src: "/images/stores/paris/01-facade.png",
        alt: "Фасад магазина Virtual Space в Париже",
        label: "Фасад",
      },
      {
        src: "/images/stores/paris/03-reception.png",
        alt: "Ресепшен магазина Virtual Space в Париже",
        label: "Ресепшен",
      },
      {
        src: "/images/stores/paris/04-detail.png",
